...
//    private val listTvshowsMutable = MutableLiveData<ArrayList<DataTvShows>>()
//
//    fun setTvShows(): ArrayList<DataTvShows>{
//        return arrayListOf(
//                DataTvShows(R.drawable.poster_arrow, "Arrow (2012)",
...
//
//                DataTvShows(R.drawable.poster_doom_patrol, "Doom Patrol (2019)",
...
//
//                DataTvShows(R.drawable.poster_flash, "The Flash (2014)",
...
//
//                DataTvShows(R.drawable.poster_god, "Game of Thrones (2011)",
...
//
//                DataTvShows(R.drawable.poster_gotham, "Gotham (2014)",
...
//
//                DataTvShows(R.drawable.poster_iron_fist, "Marvel's Iron Fist (2017)",
...
//
//                DataTvShows(R.drawable.poster_riverdale, "Riverdale (2017)",
...
//
//                DataTvShows(R.drawable.poster_supergirl, "Supergirl (2015)",
...
//                        "TV-PG | 43min | Action, Adventure, Drama"),
//
//                DataTvShows(R.drawable.poster_the_umbrella, "The Umbrella Academy (2019)",
...
//
//                DataTvShows(R.drawable.poster_the_walking_dead, "The Walking Dead (2010)",
...
//    }
//
//    fun getTvShowsViewModel(): LiveData<ArrayList<DataTvShows>>{
//        listTvshowsMutable.postValue(setTvShows())
//
